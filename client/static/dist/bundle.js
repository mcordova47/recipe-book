...
(function(exports) {
  ...
  var paragraphParser = Data_Functor.map(Text_Parsing_Simple.functorParser)(Paragraph.create)(Text_Parsing_Simple.applyL(Text_Parsing_Simple.some(inlineParser))(Text_Parsing_Simple.some(Text_Parsing_Combinators.choice(Text_Parsing_Simple.plusParser)(Data_Foldable.foldableArray)([ Text_Parsing_Simple.newline, Text_Parsing_Simple.cr ]))));
...
(function(exports) {
  ...
  var getUnitType = function (recipeComp) {
      ...
      throw new Error("Failed pattern match at App.View line 248, column 3 - line 250, column 46: " + [ recipeComp.constructor.name ]);
  };
  var getRecipeName = function (recipeComp) {
      ...
      throw new Error("Failed pattern match at App.View line 261, column 3 - line 263, column 38: " + [ recipeComp.constructor.name ]);
  };
  ...
  var inlineToHtml = function (v) {
      return function (v1) {
          return function (v2) {
              ...
              throw new Error("Failed pattern match at App.View line 195, column 1 - line 195, column 77: " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
  ...
  var recipeDirections = function (recipes) {
      return function (recipe) {
          return Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.div)(Text_Smolder_HTML_Attributes.className("recipe-directions"))((function () {
              ...
              throw new Error("Failed pattern match at App.View line 185, column 5 - line 189, column 31: " + [ v.constructor.name ]);
          })());
      };
  };
  ...
  var getCost = function (recipes) {
      return Data_Foldable.foldl(Data_List_Types.foldableList)(function (total) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at App.View line 237, column 5 - line 244, column 5: " + [ v1.constructor.name ]);
          };
      })(0.0);
  };
  ...
  var filterRecipes = function (v) {
      ...
      throw new Error("Failed pattern match at App.View line 229, column 1 - line 229, column 84: " + [ v.constructor.name ]);
  };
