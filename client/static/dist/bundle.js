...
(function(exports) {
  ...
  var label = function (lbl) {
      return function (tooltip) {
          return Text_Smolder_Markup.withEvent(Text_Smolder_Markup.eventableMarkupMF)(Text_Smolder_Markup.withEvent(Text_Smolder_Markup.eventableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.span)(Text_Smolder_HTML_Attributes.className("tooltip-label")))(Pux_DOM_Events.onMouseEnter(Hover.create(tooltip))))(Pux_DOM_Events.onMouseLeave(Data_Function["const"](Hide.value)))(Text_Smolder_Markup.text(lbl));
      };
  };
