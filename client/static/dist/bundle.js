...
(function(exports) {
  ...
  var space = function (str) {
      ...
      if (v instanceof Data_Maybe.Just) {
          ...
          var msg = "Expected a space but found " + (Data_Show.show(Data_Show.showChar)(v.value0) + (" when trying to parse the string " + (Data_Show.show(Data_Show.showString)(Data_String.take(20)(str)) + " ...")));
...
(function(exports) {
  ...
  var spaceParser = Data_Functor.map(Text_Parsing_Simple.functorParser)(Data_Function["const"](Space.value))(Text_Parsing_Simple.someChar(Text_Parsing_Combinators.choice(Text_Parsing_Simple.plusParser)(Data_Foldable.foldableArray)([ Text_Parsing_Simple.space, Text_Parsing_Simple.newline, Text_Parsing_Simple.cr ])));
  ...
  var markdownParser = Text_Parsing_Simple.many(Text_Parsing_Combinators.choice(Text_Parsing_Simple.plusParser)(Data_Foldable.foldableArray)([ linkParser, wordParser, spaceParser ]));
  ...
  var stripParsed = function (md) {
      return concat(Data_List_Types.foldableList)(Data_Monoid.monoidString)(Data_Functor.mapFlipped(Data_List_Types.functorList)(md)(function (v) {
          ...
          throw new Error("Failed pattern match at App.Markdown line 41, column 28 - line 46, column 1: " + [ v.constructor.name ]);
      }));
  };
  var tryStripMarkdown = function (text) {
      var v = Text_Parsing_Simple.parse(markdownParser)(text);
      if (v instanceof Data_Either.Right) {
          return stripParsed(v.value0);
      };
      if (v instanceof Data_Either.Left) {
          return text;
      };
      throw new Error("Failed pattern match at App.Markdown line 48, column 3 - line 50, column 19: " + [ v.constructor.name ]);
  };
  exports["Link"] = Link;
  exports["Word"] = Word;
  exports["Space"] = Space;
  ...
  exports["stripParsed"] = stripParsed;
...
(function(exports) {
  ...
  var listRecipes = function (dictOrd) {
      return function (accessor) {
          return function (recipes) {
              return Data_List.sortBy(Data_Function.on(Data_Ord.compare(dictOrd))(function ($134) {
                  return accessor(Data_Tuple.snd($134));
  ...
  var recipeNavLink = function (route) {
      return function (v) {
          var classNames = (function () {
              var $43 = isRecipeSelected(route)(v.value0);
              if ($43) {
  ...
  var ingredientView = function (recipes) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at App.View line 142, column 3 - line 158, column 1: " + [ v1.constructor.name ]);
      };
  };
  ...
  var groupRecipes = function (recipes) {
      return Data_List.groupBy(Data_Function.on(Data_Eq.eq(Data_Eq.eqString))(function ($135) {
          return (function (v) {
              return v.category;
          })(Data_Tuple.snd($135));
  ...
  var getUnitType = function (recipeComp) {
      ...
      throw new Error("Failed pattern match at App.View line 240, column 3 - line 242, column 46: " + [ recipeComp.constructor.name ]);
  };
  var getRecipeName = function (recipeComp) {
      ...
      throw new Error("Failed pattern match at App.View line 253, column 3 - line 255, column 38: " + [ recipeComp.constructor.name ]);
  };
  var recipeLink = function (recipes) {
      return function (ingredients) {
          return function (label) {
              return function (id) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Foldable.find(Data_List_Types.foldableList)(function ($136) {
                      return Data_Eq.eq(App_State.eqFoodId)(id)((function (v) {
                          return v.ingredient;
                      })(Data_Newtype.unwrap(App_State.newtypeIngredientAmount)($136)));
  ...
  var recipeDirections = function (recipes) {
      return function (recipe) {
          var md = Text_Parsing_Simple.parse(App_Markdown.markdownParser)(recipe.directions);
          return Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.div)(Text_Smolder_HTML_Attributes.className("recipe-directions"))((function () {
              ...
              if (v instanceof Data_Either.Right) {
                  return Data_Foldable.for_(Control_Monad_Free.freeApplicative)(Data_List_Types.foldableList)(v.value0)(function (v1) {
                      if (v1 instanceof App_Markdown.Space) {
                          return Text_Smolder_Markup.text(" ");
                      };
                      if (v1 instanceof App_Markdown.Word) {
                          return Text_Smolder_Markup.text(v1.value0);
                      };
                      if (v1 instanceof App_Markdown.Link) {
                          var v2 = recipeLink(recipes)(recipe.ingredients)(v1.value0)(v1.value1);
                          if (v2 instanceof Data_Maybe.Just) {
                              return v2.value0;
                          };
                          if (v2 instanceof Data_Maybe.Nothing) {
                          ...
                          throw new Error("Failed pattern match at App.View line 194, column 15 - line 196, column 38: " + [ v2.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at App.View line 188, column 25 - line 196, column 38: " + [ v1.constructor.name ]);
                  });
              };
              if (v instanceof Data_Either.Left) {
                  return Text_Smolder_Markup.text(recipe.directions);
              };
              throw new Error("Failed pattern match at App.View line 186, column 7 - line 198, column 33: " + [ v.constructor.name ]);
          })());
      };
  };
  ...
  var getCost = function (recipes) {
      return Data_Foldable.foldl(Data_List_Types.foldableList)(function (total) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at App.View line 229, column 5 - line 236, column 5: " + [ v1.constructor.name ]);
          };
      })(0.0);
  };
  ...
  var filterRecipes = function (v) {
      ...
      if (v instanceof App_Filter.Search) {
          return Data_Map.filter(App_State.ordFoodId)(function ($137) {
              return Data_String.contains(v.value0)(Data_String.toLower(getRecipeName($137)));
          });
      };
      throw new Error("Failed pattern match at App.View line 221, column 1 - line 221, column 92: " + [ v.constructor.name ]);
  };
  ...
  var categoryList = function (v) {
      return function (v1) {
          if (v1 instanceof Network_RemoteData.Success) {
              return Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.div)(Text_Smolder_HTML_Attributes.className("category-list-page"))(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.div)(Text_Smolder_HTML_Attributes.className("category-list"))(Data_Foldable.for_(Control_Monad_Free.freeApplicative)(Data_List_Types.foldableList)(groupRecipes(filterRecipes(v)(v1.value0)))(categoryView(v1.value0))));
          };
          return Text_Smolder_Markup.text("");
      };
  };
  var mainView = function (v) {
      return function (recipes) {
          ...
          throw new Error("Failed pattern match at App.View line 88, column 1 - line 88, column 58: " + [ v.constructor.name, recipes.constructor.name ]);
      };
  };
  var view = function (v) {
